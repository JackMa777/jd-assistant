...
if __name__ == '__main__':
    ...
    config.buy_time = '2021-02-07 11:59:59.970'  # 开始抢购时间，格式：'2020-11-28 12:59:59.950'，建议设置提前0.050秒，如果网络慢可根据自己网络情况适当修改

    # 配置【预约抢购，不会自动加入购物车】
    config.sku_buy_time = '2021-02-07 12:00:00.000'  # 该商品指定抢购时间，格式：'2021-01-28 14:00:00.000'，为整点，后续会改为自动设置，暂时保留
