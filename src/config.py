...
class CustomConfig(object):
    # 抢购通用配置
    sku_id = ''                 # 商品id
    sku_buy_time = ''           # 该商品指定抢购时间，格式：'2021-01-28 14:00:00.000'，为整点，后续会改为自动设置，暂时保留
    buy_time = ''               # 脚本开始抢购时间，格式：'2020-11-28 12:59:59.950'，建议设置提前0.050秒，如果网络慢可根据自己网络情况适当修改
    retry = 5                   # 抢购重试执行次数，可选参数，默认5次
